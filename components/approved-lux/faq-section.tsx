...
const faqs: FaqItem[] = [
  {
    question: "What exactly does the personal assistant service do?",
    answer:
      "Approved Lux provides a real, 24/7 US-based personal assistant who handles the planning, coordination, and execution behind everyday tasks and important moments. From travel and scheduling to reservations, home services, errands, and family coordination, we take care of the logistics so you don’t have to manage the details yourself.",
  },
  {
    question: "When are you available?",
    answer:
      "Our team is available 24/7 for members. Whether it's a last-minute flight change, a weekend dinner reservation, or a Monday-morning reminder, we’re always here.",
  },
  {
    question: "Is this a travel agency?",
    answer:
      "No — this is a full-service lifestyle concierge. Travel is just one part of what we do. In addition to trip planning, we also support dining, home management, daily essentials, personal shopping, gifting, and family needs.",
  },
  {
    question: "How fast will I get a response?",
    answer:
      "Most requests receive a response within minutes. More complex requests (like itinerary building, sourcing contractors, or personal shopping) may take a little longer, but we always update you along the way.",
  },
  {
    question: "How do I submit a request?",
    answer: "You can reach us via phone. Just tell us what you need, and we’ll take it from there.",
  },
  {
    question: "What types of things can I ask for?",
    answer:
