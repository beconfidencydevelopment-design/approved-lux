...
export default function FooterSection() {
  return (
    <footer className="text-white relative bg-[#001F63] rounded-t-[40px]">
      <div className="max-w-7xl mx-auto px-4 pt-5 lg:pt-18 space-y-[56px]">
        <div className="bg-[#E9F0FF] text-gray-900 rounded-4xl px-5 lg:px-9 py-10 lg:py-18">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h3 className="text-[28px] leading-[36px] lg:text-[36px] lg:leading-[44px] text-[#0E0E0F] font-medium">
          ...
          <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-3 text-[#C8D4F5]">
                ...
                <li>
                  <Link
                    href="https://www.approvedexperiences.com/company"
                    prefetch={false}
                    className="hover:text-white transition"
                  >
                    Company
