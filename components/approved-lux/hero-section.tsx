const VD_URL = "https://pub-0629005fcfb44f7ca99f4fbb3b9937c3.r2.dev/0_South_Beach_1920x1080.mp4";

export default function HeroSection() {
  return (
    <section className="pb-[100px]">
      <div className="relative w-full pt-[300px] lg:pt-[400px] bg-cover bg-center px-4 lg:px-0 overflow-hidden">
        <video
        ...
        <div className="relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-4 text-[18px] leading-[24px] lg:text-[20px] lg:leading-[28px] font-normal text-[#515153]">
              A real US-based person handles your travel, reservations, errands,
              and life admin.
              <span className="block">Less than Netflix + Spotify combined.</span>
            </p>
          </div>
        </div>
      </div>
